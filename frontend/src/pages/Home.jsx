...
import img from "../../public/HPE.png"
const HomePage = () => {
    ...
    <div className="home-page bg-gray-100">
      ...
      <header className="header flex flex-col items-center mb-8 py-12 bg-white shadow-lg rounded-b-lg">
        <img
          src={logo}
          alt="School Logo"
          className="logo  h-28 mb-4"
        />
        <h1 className="text-3xl font-extrabold mb-2 text-gray-800 justify-center">Welcome to Happy Childhood Enjoyment Pre School</h1>
